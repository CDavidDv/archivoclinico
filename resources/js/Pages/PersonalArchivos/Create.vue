...
const form = useForm({
    ...
    rfc: '', numero_empleado: '', cargo: '', area: '', tipo: '',
});
const submit = () => form.post(route('personal_archivos.store'));
</script>

<template>
    <AppLayout title="Nuevo Personal de Archivo">
        <PageHeader title="Nuevo Personal de Archivo" />
        <Card title="Registro de Personal de Archivo Clínico">
