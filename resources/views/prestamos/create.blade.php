            ...
            <form action="{{ route('prestamos.store') }}" method="POST">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="id_expediente"
                                ...
                                required>
                            <option value="" disabled {{ old('id_expediente') ? '' : 'selected' }}>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="id_medico"
                                ...
                                required>
                            <option value="" disabled {{ old('id_medico') ? '' : 'selected' }}>
                                Seleccione médico
                            </option>

                            @foreach($medicos as $med)
                                <option value="{{ $med->id }}"
                                    {{ old('id_medico') == $med->id ? 'selected' : '' }}>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="entregado_por"
                                ...
                                required>
                            <option value="" disabled {{ old('entregado_por') ? '' : 'selected' }}>
                                Seleccione personal
                            </option>

                            @foreach($personalArchivos as $personal)
                                <option value="{{ $personal->id }}"
                                    {{ old('entregado_por') == $personal->id ? 'selected' : '' }}>
                ...
                <div class="d-flex justify-content-end gap-2 mt-4">
                    ...
                    <button type="submit"
                            ...
                            onclick="return confirm('¿Guardar nuevo préstamo?')">
                        Guardar Préstamo
                    </button>
