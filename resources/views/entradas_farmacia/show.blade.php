...
<div class="container">
    ...
    <h1 class="mb-4 text-success fw-bold">Entrada de Farmacia #{{ $entrada->id }}</h1>
    ...
    <div class="card shadow border-0 mb-4">
        ...
        <div class="card-body">
            <dl class="row mb-0">
                ...
                <dd class="col-sm-9">{{ $entrada->transferencia?->folio ?? '—' }}</dd>
        ...
        <div class="card-footer bg-white">
            <a href="{{ route('entradas_farmacia.index') }}" class="btn btn-outline-secondary btn-sm">Volver</a>
        </div>
    </div>
