...
<div class="container">
    ...
    <h1 class="mb-4 text-success fw-bold">Salidas de Farmacia</h1>

    <div class="card shadow border-0">

        <div class="card-header bg-success text-white d-flex justify-content-between align-items-center">
            <span class="fw-semibold">Historial de Salidas</span>
            <a href="{{ route('salidas_farmacia.create') }}" class="btn btn-light btn-sm shadow-sm">
                + Nueva Salida
            </a>
        </div>
                    ...
                    <tbody>
                        @forelse($salidas as $salida)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('salidas_farmacia.show', $salida) }}"
