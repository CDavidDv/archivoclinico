...
<div class="container">
    ...
    <h1 class="mb-4 text-success fw-bold">Salida de Almacén #{{ $salida->id }}</h1>
    ...
    <div class="card shadow border-0 mb-4">
        ...
        <div class="card-body">
            <dl class="row mb-0">
                ...
                <dd class="col-sm-9">{{ ucfirst(str_replace('_', ' ', $salida->tipo)) }}</dd>

                <dt class="col-sm-3">Área destino</dt>
                <dd class="col-sm-9">{{ $salida->area_destino ?? '—' }}</dd>
        ...
        <div class="card-footer bg-white">
            <a href="{{ route('salidas_almacen.index') }}" class="btn btn-outline-secondary btn-sm">Volver</a>
        </div>
    </div>
